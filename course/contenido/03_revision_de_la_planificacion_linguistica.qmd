...
**2. Codificación** (*codification of norm*). Proceso de dar forma explícita —generalmente escrita— a la norma seleccionada. Haugen ([1982](../references.html#haugen1982)) distingue tres subprocesos:
...
1. **Planificación** (*planning*): obtención de datos sociolingüísticos para describir el problema e identificar posibles soluciones.
...
1. ¿Es necesaria y legítima la planificación lingüística, o es una intervención inaceptable en el desarrollo natural de las lenguas?
2. ¿Debe participar el lingüista en los procesos de planificación, o debe limitarse a describir?
...
Esto implica, sin embargo, una responsabilidad: el lingüista debe ser consciente de que sus decisiones técnicas tienen consecuencias políticas y sociales.
<hr>
[Anterior tema](02_historia_de_las_politicas_del_lenguaje.html) | [Siguiente tema]()
